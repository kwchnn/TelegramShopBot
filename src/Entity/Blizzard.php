...
class Blizzard
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\BlizzardGames", inversedBy="blizzard")
     */
    private $blizzard_games;
    ...
    public function getBlizzardGames(): ?BlizzardGames
    {
        return $this->blizzard_games;
    }

    public function setBlizzardGames(?BlizzardGames $blizzard_games): self
    {
        $this->blizzard_games = $blizzard_games;
